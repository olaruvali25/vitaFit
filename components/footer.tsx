            ...
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    {links.map((link, index) => (
                        <Link
                            key={index}
                            href={link.href}
                            className="text-white/60 hover:text-[#18c260] block duration-150 transition-colors">
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    <Link
                        ...
                        className="text-white/60 hover:text-[#18c260] block transition-colors">
                        <svg
                            className="size-6"
                ...
                <span className="text-white/50 block text-center text-sm"> © {new Date().getFullYear()} VitaFit. All rights reserved.</span>
            </div>
        </footer>
    )
}
