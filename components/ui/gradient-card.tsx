...
const cardVariants = cva(
  "relative flex flex-col justify-between h-full w-full min-w-[500px] overflow-hidden rounded-2xl p-8 shadow-sm transition-shadow duration-300 hover:shadow-lg",
  {
    variants: {
      gradient: {
