...
>(({ className, index, cardTitle, tag, title, imageSrc, color, ...props }, ref) => {
  ...
  return (
    <motion.div
      ...
      style={cardStyle}
      className={cn(
        "relative flex h-[380px] w-full min-w-[400px] flex-col justify-end overflow-hidden rounded-2xl border border-white/20 bg-white/5 backdrop-blur-xl p-8 shadow-sm",
        className
      )}
      whileHover="hover"
      initial="initial"
