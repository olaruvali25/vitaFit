...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-muted p-1 text-white/70",
      className
    )}
    {...props}
  />
  ...
  return (
    <button
      ...
      className={cn(
        ...
        // All tabs use green color - emerald-400 for active, emerald-500/70 for inactive
        isActive 
          ? "bg-background text-emerald-400 shadow-sm" 
          : "text-emerald-500/70 hover:bg-background/50 hover:text-emerald-400",
        className
      )}
