...
const companyStats = [
  ...
  { label: "Get tailored answers about your meals & goals", value: "1:1 Guidance", icon: Globe },
  { label: "Successfully generated with VitaFit", value: "10,000+ Meals", icon: Shield },
  { label: "Stick to Their VitaFit Plan", value: "96%", icon: Zap }
];
  ...
  return (
    <section className="relative py-32 bg-gradient-to-br from-black via-green-950/20 to-black text-white overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Moving orbs */}
        <motion.div
          className="absolute top-1/3 left-1/5 w-96 h-96 bg-[#18c260]/10 rounded-full blur-3xl"
          animate={{
            x: [0, 200, 0],
            y: [0, 100, 0],
            scale: [1, 1.3, 1],
        ...
        />
        <motion.div
          className="absolute bottom-1/4 right-1/5 w-80 h-80 bg-green-400/10 rounded-full blur-3xl"
          animate={{
            x: [0, -150, 0],
            y: [0, -80, 0],
            scale: [1, 1.2, 1],
      ...
      >
        ...
        >
          ...
          >
            ...
            We'll reply as fast as possible.
          </motion.p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              {!isSubmitted ? (
                ...
                >
                  ...
                  <motion.button
                    ...
                    className="w-full relative group overflow-hidden bg-gradient-to-r from-[#18c260] to-[#1FCC5F] hover:from-[#1FCC5F] hover:to-[#18c260] text-white font-medium py-4 px-6 rounded-xl transition-all disabled:opacity-50"
          ...
          >
            ...
            >
              {/* Outer Glow Ring */}
              <motion.div
                className="absolute inset-0 rounded-full bg-gradient-to-br from-[#18c260]/30 to-green-500/30 blur-3xl"
                animate={{
                  scale: [1, 1.1, 1],
                  opacity: [0.3, 0.5, 0.3],
                }}
              ...
              <motion.div
                className="relative w-full h-full rounded-full bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-xl border border-white/20 flex items-center justify-center overflow-hidden"
                whileHover={{ scale: 1.05 }}
                transition={{ duration: 0.3 }}
              >
                {/* Inner Gradient Rings */}
                <motion.div
                  className="absolute inset-8 rounded-full border-2 border-[#18c260]/40"
                  animate={{
                    rotate: [0, 360],
                  }}
                  transition={{
              ...
              {/* Corner Accents */}
              <motion.div
                className="absolute -top-4 -right-4 w-20 h-20 rounded-full bg-gradient-to-br from-[#18c260]/40 to-transparent blur-2xl"
                animate={{
                  scale: [1, 1.2, 1],
                  opacity: [0.4, 0.7, 0.4],
                }}
              ...
              />
              <motion.div
                className="absolute -bottom-4 -left-4 w-24 h-24 rounded-full bg-gradient-to-br from-green-400/40 to-transparent blur-2xl"
                animate={{
                  scale: [1, 1.3, 1],
                  opacity: [0.4, 0.7, 0.4],
                }}
