...
useEffect(() => {
  ...
  return (
    ...
    <div className="bg-gradient-to-br from-emerald-50 via-teal-50 to-emerald-100/40 min-h-screen w-full flex flex-col relative overflow-hidden py-4 md:py-0">
        ...
        <div className={cn("flex w-full flex-1 h-full items-center justify-center min-h-screen py-4 md:py-0", "relative overflow-hidden")}>

            {/* Subtle background overlay */}
            <div className="absolute inset-0 z-0 bg-gradient-to-br from-emerald-50/50 via-teal-50/30 to-emerald-100/20">
              {/* Very subtle green shadows */}
              <div className="absolute top-0 left-0 w-96 h-96 bg-emerald-200/10 rounded-full blur-3xl -z-10" />
              <div className="absolute bottom-0 right-0 w-96 h-96 bg-teal-200/10 rounded-full blur-3xl -z-10" />
            </div>

            <fieldset disabled={modalStatus !== 'closed'} className="relative z-10 flex flex-col items-center gap-4 md:gap-8 w-full max-w-[280px] mx-auto px-4 py-4 md:p-4">
                ...
                <AnimatePresence mode="wait">
                    ...
                    {authStep === "email" && <motion.div key="email-content" initial={{ y: 6, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ opacity: 0 }} transition={{ duration: 0.3, ease: "easeOut" }} className="w-full flex flex-col items-center gap-4">
                        ...
                        <BlurFade delay={0.25 * 1} className="w-full"><div className="text-center"><p className="font-serif font-light text-2xl sm:text-4xl md:text-5xl lg:text-6xl tracking-tight text-foreground">Start Your Journey With <span className="text-emerald-300 font-bold">VitaFit</span> Now!</p></div></BlurFade>
                    ...
                    {authStep === "password" && <motion.div key="password-title" initial={{ y: 6, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ opacity: 0 }} transition={{ duration: 0.3, ease: "easeOut" }} className="w-full flex flex-col items-center text-center gap-4">
                        ...
                        <BlurFade delay={0} className="w-full"><div className="text-center"><p className="font-serif font-light text-2xl sm:text-4xl md:text-5xl tracking-tight text-foreground">Create your password</p></div></BlurFade>
                     ...
                     {authStep === "confirmPassword" && <motion.div key="confirm-title" initial={{ y: 6, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ opacity: 0 }} transition={{ duration: 0.3, ease: "easeOut" }} className="w-full flex flex-col items-center text-center gap-4">
                         ...
                         <BlurFade delay={0} className="w-full"><div className="text-center"><p className="font-serif font-light text-2xl sm:text-4xl md:text-5xl tracking-tight text-foreground">One Last Step</p></div></BlurFade>
                            ...
                            {authStep === 'email' && (
                                <div className="w-full mt-4">
                                    <button
                                        ...
                                        onClick={() => {
                                            if (isEmailValid) {
                                                window.location.href = `/assessment?email=${encodeURIComponent(email.trim())}`
                                            }
                                        }}
                                        className={`w-full font-semibold py-3 px-6 rounded-full transition-colors duration-300 shadow-lg hover:shadow-xl ${
                                            isEmailValid 
                                                ? 'bg-emerald-300 hover:bg-emerald-400 text-gray-900 cursor-pointer' 
                                                : 'bg-emerald-300/50 text-gray-500 cursor-not-allowed opacity-60'
                                        }`}
                                    >
                                        Start Now
                                    </button>
